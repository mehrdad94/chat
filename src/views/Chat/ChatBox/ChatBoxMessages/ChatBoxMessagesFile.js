...
function MessageUserBody (props) {
  return (
    <div className="layer">
      <div className="peers fxw-nw ai-c pY-10 pX-15 bgc-white bdrs-2 lh-3/2 bdB">
        <div className="peer ord-0">
          {
            props.downloading ? (
              <button className="btn btn-link rounded-circle p-10 bd mR-15 d-f">
        ...
        <div className="peer ord-0">
          <span className="c-blue-grey-900">{props.fileName}</span>
        </div>
      </div>

      <div className="peers fxw-nw ai-c pY-3 pX-15 bgc-white bdrs-2 lh-3/2">
...
export function MessagesFileCurrentUser (props) {
  return (
...
export function MessagesFilePartners (props) {
  return (
